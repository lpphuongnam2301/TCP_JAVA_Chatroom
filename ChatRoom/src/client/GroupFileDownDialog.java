 ...
 * @author lpphu
 */
public class GroupFileDownDialog extends javax.swing.JFrame {
    FormatTable formatTable = new FormatTable();
    DefaultTableModel model;
    public static ArrayList<GroupMessageDTO> arrMess;
    /**
     * Creates new form UserFileDownDialog
     */
    public GroupFileDownDialog() {
        initComponents();
        tableFormat();
        loadTable();
    }
    ...
    public void loadTable()
    {
        if(!arrMess.isEmpty())
        {
            try {
                ...
                for (GroupMessageDTO str : arrMess) {
                    
                        Vector row = new Vector();
                        row.add(str.getGroup_message_id());
        ...
        addbtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                try
                {
                    ...
                    byte[] arrB = null;
                    for(GroupMessageDTO nam : arrMess)
                    {
                        if(nam.getGroup_message_id() == Integer.parseInt(table.getValueAt(i, 0).toString()))
                        {
                            arrB = nam.getArrByte();
                            break;
                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupFileDownDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GroupFileDownDialog().setVisible(true);
            }
        });
    }
