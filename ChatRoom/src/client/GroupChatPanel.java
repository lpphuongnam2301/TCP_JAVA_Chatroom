 ...
 * @author lpphu
 */
public class GroupChatPanel extends javax.swing.JPanel implements MouseListener{
    ...
    {
        if (JOptionPane.showConfirmDialog(this, "Out group '" + nameLb.getText() + "'?", "WARNING",
        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) 
        {
            ObjectSend obj = new ObjectSend("out_group", OverrallFrame.userEmail,currentGroupId +","+nameLb.getText());
    ...
    {
        if (JOptionPane.showConfirmDialog(this, "Block group '" + nameLb.getText() + "'?", "WARNING",
        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) 
        {
            //System.out.println(currentEmail + ": " + OverrallFrame.userEmail);
            ObjectSend obj = new ObjectSend("block_group", OverrallFrame.userEmail,currentGroupId);
            OverrallFrame.write(obj);
        } 
    }
    ...
    public void sendMess(String content, String file, String emoji, byte[] arrByte)
    {
            ...
            int groupId = Integer.parseInt(currentGroupId);
            String time = ObjectSend.getCurrentTime();
            if(!content.equals("null"))
            {
                updateChat_send(content, time);
            } else if (!emoji.equals("null"))
            {
                String msg = "<img src='" + getClass().getResource("/emoji/" + emoji) + "'></img>";
                updateChat_send(msg, time);
            } else if (!file.equals("null"))
            {
                String msg = "<span style='font-weight:bold;font-size:12px;'>FILE:  </span>" + file;
                updateChat_send(msg, time);
            }
                        
            GroupMessageDTO dto = new GroupMessageDTO(OverrallFrame.userEmail, time, content, groupId, file, emoji, arrByte);
            dto.setGroup_name(currentGroupName);
            ObjectSend obj = new ObjectSend("send_mess_to_group", dto);
            OverrallFrame.write(obj);
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-do-not-disturb-20.png"))); // NOI18N
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 50, 40));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-exit1-20.png"))); // NOI18N
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 50, 40));

        addMember.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-join-skin-type-7-20.png"))); // NOI18N
        ...
        jPanel2.add(addMember, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 10, 50, 40));
        ...
        jPanel2.add(filelistBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 50, 40));
    ...
    private void addMemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addMemberActionPerformed
        // TODO add your handling code here:
        ObjectSend obj = new ObjectSend("get_edit_group_info", currentGroupId, currentGroupName, OverrallFrame.userEmail);
        OverrallFrame.write(obj);
    ...
    private void filelistBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filelistBtnActionPerformed
        // TODO add your handling code here:
        ObjectSend obj = new ObjectSend<>("get_file_group_mess_list", currentGroupId);
        OverrallFrame.write(obj);
