...
public class Handler implements Runnable {
    ...
    public Handler(Socket socket, String mail, String key) {
        try {
            this.socket = socket;
    ...
    public void run() {        
        while (socket.isConnected()) 
        {
            try 
            {
                ...
                obj = gson.fromJson(decrypStr , ObjectSend.class);
                //System.out.println(decrypStr);
                ...
                {
                    MessageDTO dto = gson.fromJson(gson.toJson(obj.getObject()), MessageDTO.class);
                    dal.addMess(dto);
                ...
                {
                    GroupMessageDTO dto = gson.fromJson(gson.toJson(obj.getObject()), GroupMessageDTO.class);
                ...
                if(obj.getTag().equals("update_mess_status"))
                {
                    ...
                    double value = (double)obj.getObjectTemp();
                    dal.updateMessStatus(object.split(",")[0],object.split(",")[1], (int) value);
                ...
                if(obj.getTag().equals("out_group"))
                {
                    ...
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+ user + " rời nhóm '" + groupName + "'");
                }
...
//                    //ghi log
//                    ServerMain.wirteLog(user + " từ chối kết bạn với" + friend);
                }
...
//                  //friend
                    ...
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+user + " đã kết bạn với" + friend);
                }
                ...
                {            
                    ...
                    ArrayList<String> userList = gson.fromJson(gson.toJson(obj.getArr()), listType);
                ...
                {            
                    ...
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+userEmail + " đã tạo nhóm mới '" + groupName +"'");
                }
                ...
                {          
                    ...
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+user.getUser_email() + " đổi thông tin");
//                    ObjectSend objSend = new ObjectSend("get_edit_user_info", dal.readUserInfo(user.getUser_email()));
//                    write(objSend);
                }
                if(obj.getTag().equals("edit_user_pass"))
                {            
                    String mail = (String)obj.getObject();
                    String pass = (String)obj.getObjectTemp();
                    dal.updatePassUser(pass, mail);
                    
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+mail + " đổi mật khẩu");
//                    ObjectSend objSend = new ObjectSend("get_edit_user_info", dal.readUserInfo(user.getUser_email()));
//                    write(objSend);
                }
                ...
                {            
                    ...
                    for(Handler a : serverThreadBus.getListServerThreads())
                    {
                    ...
                    //ghi log
                    ServerMain.wirteLog(ObjectSend.getCurrentTime()+": "+userEmail + " đã logout");
                    ServerMain.updateTotalUserOnl(false);
                    ServerMain.loadUserOnl();
                    break;
                }
            } catch (IOException ex) 
            {
